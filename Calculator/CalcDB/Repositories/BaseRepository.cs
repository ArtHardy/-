...
namespace CalcDB.Repositories
{
        ...
        where T : IEntity
    {
        ...
        protected string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\work\Калькулятор\Calculator\CalcDB\AppData\CalcDB.mdf;Integrated Security=True";
